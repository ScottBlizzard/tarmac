...
OBJECTIVES = ["balanced_accuracy", "high_sensitivity"]
TARGET_ACCEPT_ACCS = [0.88, 0.90]
...
def main() -> None:
    ...
    internal = internal.merge(internal_probs, on="case_id", how="left", validate="one_to_one")
    external = external.merge(external_probs, on="case_id", how="left", validate="one_to_one")
