...
TARGET_ACCEPT_ACCS = [0.88, 0.90, 0.92]
CORRECTOR_CONF_THRESHOLDS = [0.00, 0.60, 0.65]
MIN_ACCEPT_TRAIN = 30
...
def main() -> None:
    ...
    ms = models(20260527)
    gate_models = {"base_conf_core": None, "gate_logreg": ms["logreg_c03"]}
    corr_models = {"corr_logreg": ms["logreg_c03"], "corr_extra": ms["extra_depth3"]}

    rows: list[dict[str, object]] = []
    case_frames: list[pd.DataFrame] = []
    for feature_set in ["core", "multiview"]:
