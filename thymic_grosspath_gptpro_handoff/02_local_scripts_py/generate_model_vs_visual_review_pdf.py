...
SOURCE_MD = ROOT / "汇报" / "模型结果与纯视觉审阅对照简报_2026-05-09.md"
OUTPUT_PDF = ROOT / "汇报" / "模型结果与纯视觉审阅对照简报_2026-05-09.pdf"
FONT_PATH = Path(r"C:\Windows\Fonts\simhei.ttf")
FONT_NAME = "SimHeiModelVsVisual"
...
def table_widths(ncols: int, page_width: float) -> list[float]:
    ...
    presets = {
        3: [0.24, 0.24, 0.52],
        4: [0.14, 0.24, 0.24, 0.38],
        5: [0.18, 0.20, 0.22, 0.18, 0.22],
    }
